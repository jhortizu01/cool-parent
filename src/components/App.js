...
function App() {
  ...
  return (
    <div className="App">
        <Main allParents={allParents} allEvents={allEvents} setParentState={setParentState} setEventState={setEventState} errorState={errorState} setErrorState={setErrorState}/>
    </div>
  );
}
